...
<div class="page_title">
    <h2 class="fl">配送方式</h2>
    <a href="#" class="fr top_rt_btn add_icon">添加配送方式</a>
</div>
<table class="table">
    <tr>
        <th>缩略图</th>
    ...
    <tr>
        <td class="center"><img src="${pageContext.request.contextPath}/admin/upload/shentong.png" width="165" height="65"/></td>
        <td>申通快递</td>
    ...
    <tr>
        <td class="center"><img src="${pageContext.request.contextPath}/admin/upload/yuantong.png" width="165" height="65"/></td>
        <td>圆通快递</td>
    ...
    <tr>
        <td class="center"><img src="${pageContext.request.contextPath}/admin/upload/yunda.png" width="165" height="65"/></td>
        <td>韵达快递</td>
