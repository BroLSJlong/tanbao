...
<div class="locfre">
    <a href="tuikuan.jsp" >退款申请</a>
    <a href="#" class="zuliyesi">退货申请</a>
</div>
...
<div class="zhuzhuxia">
    ...
    <span><a href="dingdanxiangqing.jsp" style=" line-height:58px; color:#111" class="yseal">查看</a></span>
</div>
<!--一条列表结束-->
<script>
    $(function(){
