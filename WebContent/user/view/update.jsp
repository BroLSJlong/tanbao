...
<div class="baseopxg">
    ...
    <div class="tirstbf" id="headImg">
                	<span>
                    	<img src="/tanbao/userImgs/head.jpg" />
    ...
    <div class="thetwobf">
        <em>昵称：</em>
        <h5><%=user.getMyInfo().getUserName()%></h5>
    </div>
    <div class="thetwobf">
        <em>性别：</em>
        <h5><%=TypeConversion.userSexConversion(user.getMyInfo().getUserSex())%></h5>
    </div>
    <div class="thetwobf">
        <em>电话：</em>
        <h5><%=user.getMyInfo().getPhone()%></h5>
    </div>
    <div class="thetwobf">
        <em>邮箱：</em>
        <h5><%=user.getMyInfo().getEmail()%></h5>
    </div>
    <div class="thetwobf">
        <em>出生日期：</em>
        <h5><%=user.getMyInfo().getUserBorn()%></h5>
    </div>
</div>
<!--修改基本信息结束-->
